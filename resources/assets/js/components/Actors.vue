            ...
            <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="create-actor-name" type="text" class="form-control"
                                               name="nombres" @keyup.enter="storeVue" v-model="createForm.nombres">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="apellidos"
                                                    @keyup.enter="storeVue" v-model="createForm.apellidos">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" @click="storeVue">
                            Guardar
                        </button>
                    </div>
                </div>
